...
if(isset($_POST['submit'])){
		...
		$sql="DELETE from image_table where $id=image_table.id";

		if(mysqli_query($conn,$sql)){
			//mysqli_close($conn);
		}

		$sql="INSERT INTO image_table(id,image)  VALUES('$id','$image')";
        ...
        <div id="form">
            <h1>MY PROFILE</h1>
							...
							<?php
										...
										$sql='SELECT id,image from image_table';
